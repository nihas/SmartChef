package com.nihas.smart.chef.customui;

/**
 * Created by snyxius on 10/20/2015.
 */
...
public class GradientHalfoverImageDrawableTop extends BitmapDrawable {

    private int[] gradientColors;
    private float[] gradientPositions;
    private double gradientStart = 0.0;
    private double gradientEnd = 0.3;

    public GradientHalfoverImageDrawableTop(Resources res, Bitmap bitmap) {
        super(res, bitmap);
    }

    public GradientHalfoverImageDrawableTop(Resources res, String filepath) {
        super(res, filepath);
    }

    public GradientHalfoverImageDrawableTop(Resources res, InputStream is) {
        super(res, is);
    }
