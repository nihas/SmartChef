...
public class GradientHalfoverImageDrawable extends BitmapDrawable {

    private int[] gradientColors;
    private float[] gradientPositions;
    private double gradientStart = 0.3;
    private double gradientEnd = 1;

    public GradientHalfoverImageDrawable(Resources res, Bitmap bitmap) {
        super(res, bitmap);
    }

    public GradientHalfoverImageDrawable(Resources res, String filepath) {
        super(res, filepath);
    }

    public GradientHalfoverImageDrawable(Resources res, InputStream is) {
        super(res, is);
    }
