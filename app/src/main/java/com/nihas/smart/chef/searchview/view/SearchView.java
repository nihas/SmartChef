package com.nihas.smart.chef.searchview.view;
...
public class SearchView extends FrameLayout implements Filter.FilterListener {
    ...
    private int mVersion = com.nihas.smart.chef.searchview.view.SearchCodes.VERSION_TOOLBAR;
    private int mStyle = com.nihas.smart.chef.searchview.view.SearchCodes.STYLE_TOOLBAR_CLASSIC;
    private String VOICE_SEARCH_TEXT = "Speak now";
    private int ANIMATION_DURATION = 360;
    private View mViewDivider;
    private boolean mIsSearchOpen = false;
    private boolean mClearingFocus;
    private com.nihas.smart.chef.searchview.adapter.SearchAdapter mSearchAdapter;
    ...
    private final OnClickListener mOnClickListener = new OnClickListener() {
        ...
        public void onClick(View v) {
            if (v == mBackImageView) {
                if (mVersion == com.nihas.smart.chef.searchview.view.SearchCodes.VERSION_TOOLBAR) {
                    clearFocusedItem();
                }
                if (mVersion == com.nihas.smart.chef.searchview.view.SearchCodes.VERSION_MENU_ITEM) {
                    hide(true);
                    clearFocusedItem();
                }
    ...
    private void initView() {
        ...
        com.nihas.smart.chef.searchview.view.SearchLinearLayoutManager layoutManager = new com.nihas.smart.chef.searchview.view.SearchLinearLayoutManager(mContext);
    ...
    private void initStyle(AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        if (attr != null) {
            if (attr.hasValue(R.styleable.SearchView_search_version)) {
                setVersion(attr.getInt(R.styleable.SearchView_search_version, com.nihas.smart.chef.searchview.view.SearchCodes.VERSION_TOOLBAR));
            }
            if (attr.hasValue(R.styleable.SearchView_search_style)) {
                setStyle(attr.getInt(R.styleable.SearchView_search_style, com.nihas.smart.chef.searchview.view.SearchCodes.STYLE_TOOLBAR_CLASSIC));
            }
            if (attr.hasValue(R.styleable.SearchView_search_theme)) {
                setTheme(attr.getInt(R.styleable.SearchView_search_theme, com.nihas.smart.chef.searchview.view.SearchCodes.THEME_LIGHT));
            }
    ...
    public void setStyle(int style) {
        if (mVersion == com.nihas.smart.chef.searchview.view.SearchCodes.VERSION_TOOLBAR) {
            if (style == com.nihas.smart.chef.searchview.view.SearchCodes.STYLE_TOOLBAR_CLASSIC) {
        ...
        if (mVersion == com.nihas.smart.chef.searchview.view.SearchCodes.VERSION_MENU_ITEM) {
            if (style == com.nihas.smart.chef.searchview.view.SearchCodes.STYLE_MENU_ITEM_CLASSIC) {
                mBackImageView.setImageResource(R.drawable.search_ic_arrow_back_black_24dp);
                mVoiceImageView.setImageResource(R.drawable.search_ic_mic_black_24dp);
                mEmptyImageView.setImageResource(R.drawable.search_ic_clear_black_24dp);
            }
            if (style == com.nihas.smart.chef.searchview.view.SearchCodes.STYLE_MENU_ITEM_COLOR) {
    ...
    public void setTheme(int theme) {
        if (theme == com.nihas.smart.chef.searchview.view.SearchCodes.THEME_LIGHT) {
            if (mVersion == com.nihas.smart.chef.searchview.view.SearchCodes.VERSION_TOOLBAR) {
            ...
            if (mVersion == com.nihas.smart.chef.searchview.view.SearchCodes.VERSION_MENU_ITEM) {
                if (mStyle == com.nihas.smart.chef.searchview.view.SearchCodes.STYLE_MENU_ITEM_CLASSIC) {
        ...
        if (theme == com.nihas.smart.chef.searchview.view.SearchCodes.THEME_DARK) {
            if (mVersion == com.nihas.smart.chef.searchview.view.SearchCodes.VERSION_TOOLBAR) {
    ...
    public void setDivider(boolean divider) {
        if (divider) {
            mRecyclerView.addItemDecoration(new com.nihas.smart.chef.searchview.view.SearchDivider(mContext));
        } else {
            mRecyclerView.removeItemDecoration(new com.nihas.smart.chef.searchview.view.SearchDivider(mContext));
        }
    }
    ...
    public void setAdapter(com.nihas.smart.chef.searchview.adapter.SearchAdapter adapter) {
